            ...
            >
              ...
              <motion.div variants={fadeUp} className="bg-warm-white rounded-xl p-6">
                ...
                <div className="flex gap-3">
                  <a href="https://www.instagram.com/bkfinance_global/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-navy flex items-center justify-center hover:bg-gold transition-colors">
